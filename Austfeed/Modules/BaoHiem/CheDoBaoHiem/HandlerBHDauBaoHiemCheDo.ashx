<%@ WebHandler Language="C#" Class="HandlerBHDauBaoHiemCheDo" %>

using System;
using System.Web;

public class HandlerBHDauBaoHiemCheDo : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        data = new BHDauPhieuController().GetCheDo( madonvi, start, limit, out count);
