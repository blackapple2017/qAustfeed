...
/// <summary>
/// Summary description for rpwgSub_KinhNghiemCongTac
/// </summary>
public class rpwgSub_KinhNghiemCongTac : DevExpress.XtraReports.UI.XtraReport
{
    ...
    public rpwgSub_KinhNghiemCongTac()
    {
        InitializeComponent();
        //
    ...
    {
        DataTable dt = DataController.DataHandler.GetInstance().ExecuteDataTable("WGGetSub_KinhNghiemCongTac", "@Id",prkey);
        if (dt.Rows.Count > 0)
        {
            DataSource = dt;
            xrTableCell5.DataBindings.Add("Text", DataSource, "ThoiGian");
            xrTableCell10.DataBindings.Add("Text", DataSource, "NoiLamViec");
            xrTableCell11.DataBindings.Add("Text", DataSource, "ViTriCongViec");
            xrTableCell9.DataBindings.Add("Text", DataSource, "MucLuong","{0:n0}");
            xrTableCell12.DataBindings.Add("Text", DataSource, "LyDoThoiViec");
        }
    }
