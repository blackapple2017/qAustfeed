...
/// <summary>
/// Summary description for rp_BaoCaoNhanVienChuaCoSoBHXH
/// </summary>
public class rp_BaoCaoNhanVienChuaCoSoBHXH : DevExpress.XtraReports.UI.XtraReport
{
    ...
    public rp_BaoCaoNhanVienChuaCoSoBHXH()
    {
        InitializeComponent();
        //
    ...
    public void BindData(ReportFilter filter)
    {
        ...
        DataTable table = DataHandler.GetInstance().ExecuteDataTable("report_NhanVienChuaCoBHXH", "@MaBoPhan", "@Gender", "@TinhTrang", "@MinSeniority", "@MaxSeniority", "@WhereClause", filter.SelectedDepartment, filter.Gender, filter.WorkingStatus, filter.MinSeniority, filter.MaxSeniority, filter.WhereClause);
        DataSource = table;
