...
/// <summary>
/// Summary description for rp_austfeed_DanhSachCBNVCongTy
/// </summary>
public class rp_austfeed_DanhSachCBNVCongTy : DevExpress.XtraReports.UI.XtraReport
{
	...
	public rp_austfeed_DanhSachCBNVCongTy()
	{
		InitializeComponent();
		//
    ...
    public void BinData(ReportFilter filter)
    {
        ...
        DataTable table = DataHandler.GetInstance().ExecuteDataTable("rp_BaoCaoDanhSachCBCNVCongTy", "@WhereClause","@GioiTinh", filter.WhereClause, filter.Gender);
        DataSource = table;
        xrTableCell7.DataBindings.Add("Text", DataSource, "HO_TEN");
        xrTableCell8.DataBindings.Add("Text", DataSource, "NGAY_SINH", "{0:dd/MM/yyyy}");
        xrTableCell9.DataBindings.Add("Text", DataSource, "NGAY_HDONG","{0:dd/MM/yyyy}");
        xrTableCell10.DataBindings.Add("Text", DataSource, "TEN_LOAI_HDONG");
